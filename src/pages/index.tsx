  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Construction tool rental v1 - Empowering individuals to access top-quality construction tools from our multiple outlets. Your project, our tools, endless possibilities."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Construction tool rental v1 - Empowering individuals to access top-quality construction tools from our multiple outlets. Your project, our tools, endless possibilities.`}
            </Text>
            <Box
